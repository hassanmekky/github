            ...
            <div class="up-box">
                <div class="container">
                    <div class="up-form">
                        ...
                        <form action="{{ url('admin/editcourse/'.$course->id) }}" method="post" class="add-form" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="up_form-item">
                                <h1>عنوان الدورة</h1>
                                <input type="text" name="title" value="{{ $course->course_name }}" placeholder="اضف عنوان الدورة">
                            </div>
                            <!-- /.up_form-item -->
                            <div class="up_form-item">
                                <h1>متطلب سابق</h1>
                                <input type="text" name="prev_know" value="{{ $course->prev_know }}" placeholder="متطلب سابق">
                            </div>
                            <!-- /.up_form-item -->
                            <div class="up_form-item">
                                <h1>المجال</h1>
                                        ...
                                        <div class="add_cont text-right">
                                            ...
                                            <div class="col-xs-12">
                                               <!-- <span><i class="fa fa-video-camera"></i> ارفع فيديو من جهازك</span>-->
                                                <input type="file" name="intro_video" value="{{ $course->intro_video }}" class="uploaded">
                                            </div>
                                            <!--
                                                                                <label class="text-right">
                           ...
                           <div class="up_form-item">
                            ...
                            <div class="up_form-item">
                                ...
                                <div class="add_cont text-right">
                                    ...
                                    <input type="file" name="image" value="{{ $course->image }}" data-toggle="tooltip" data-placement="top" title="اضف صورة غلاف">
                                </div>
                            </div>
                            <!-- /.up_form-item -->
                            ...
                            <div class="up_form-item">
                                ...
                                <div class="">
                                    <div class="up_form-item">
                                        <h1>إسم الشهادة</h1>
                                        <input type="text" name="cert_name" value="{{ $course->cert_name }}" placeholder="اضف اسم الشهادة">
                                    </div>
                                    <!-- /.up_form-item -->
                                    <div class="up_form-item">
                                        <h1>الجهة المانحة</h1>
                                        <input type="text" name="cert_orgnization" value="{{ $course->cert_orgnization }}" placeholder="اضف الجهة المانحة">
                                    </div>
                                    <!-- /.up_form-item -->
                                    <div class="up_form-item">
                                        <h1>تكلفة الشهادة</h1>
