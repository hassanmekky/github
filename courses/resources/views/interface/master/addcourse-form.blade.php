            ...
            <div class="up-box">
                <div class="container">
                    <div class="up-form">
                        ...
                        <form action="/addcourse/{{ Auth::guard('web')->user()->id }}" method="post" class="add-form" enctype="multipart/form-data">
                        	{{ csrf_field() }}
                            <div class="up_form-item">
                                <h1>عنوان الدورة</h1>
                                <input type="text" name="title" placeholder="اضف عنوان الدورة" required>
                            </div>
                            <!-- /.up_form-item -->
                            <div class="up_form-item">
                                <h1>متطلب سابق</h1>
                                <input type="text" name="prev_know" placeholder="متطلب سابق" required>
                            </div>
                            <!-- /.up_form-item -->
                            <div class="up_form-item">
                                <h1>المجال</h1>
                            ...
                            <div class="up_form-item">
                                <h1>وصف الدورة</h1>
                                <textarea name="description" placeholder="اضف وصف الدورة" required></textarea>
                            </div>
                            <!-- /.up_form-item -->
                            <div class="up_form-item">
                                <h1>الجنس المتوقع</h1>
                            ...
                            <div class="up_form-item">
                                ...
                                <input type="date" name="start_date" placeholder="اضف عنوان الدورة" required>
                            </div>

                           <div class="up_form-item">
                                <h1>تاريخ نهاية الدورة</h1>
                                <input type="date" name="end_date" placeholder="اضف عنوان الدورة">
                            </div>
